...
const level4: LevelDefinition = {
  ...
  walls: [
    ...
    wall(18,  5, 10, 2, C64.LIGHT_GREY),  // 1  — upper centre
    ...
    wall(3,  22, 10, 2, C64.LIGHT_GREY),  // 5  — left lower
    wall(3,  14,  9, 2, C64.LIGHT_GREY),  // 6  — left mid
  ],
  pads: [
    { id: 'H', x: 1,  y: 8,  width: 8  },
    { id: '1', x: 18, y: 5,  width: 9  },
    { id: '2', x: 36, y: 8,  width: 10 },
    { id: '3', x: 38, y: 17, width: 8  },
    { id: '4', x: 21, y: 26, width: 11 },
    { id: '5', x: 3,  y: 22, width: 9  },
    { id: '6', x: 3,  y: 14, width: 8  },
  ],
  passengers: [
    { padId: '1', destPadId: '4' },
    { padId: '2', destPadId: '6' },
